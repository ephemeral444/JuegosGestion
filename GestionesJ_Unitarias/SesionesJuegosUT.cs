...
namespace GestionesJ_Unitarias
{
    ...
    public class SesionesJuegosUT
    {
        ...
        private SesionesJuegos? entidad;
        ...
        private void Guardar()
        {
            ...
            this.iConexion.SaveChanges();
            this.entidad = new SesionesJuegos()
            {
                NombreJuego = "UT-" + DateTime.Now.ToString(),
                Duracion = "2h",
                VideojuegoId = this.videojuego.Id,
                UsuarioId = this.usuario.Id
            };
            this.iConexion.SesionesJuegos!.Add(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Modificar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.entidad!.Duracion = "4h";
            this.iConexion.SesionesJuegos!.Update(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Borrar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.iConexion.SesionesJuegos!.Remove(this.entidad!);
