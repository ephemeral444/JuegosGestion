...
namespace GestionesJ_Unitarias
{
    ...
    public class GuardadoJuegosUT
    {
        ...
        private GuardadoJuegos? entidad;
        ...
        private void Guardar()
        {
            ...
            this.iConexion.SaveChanges();
            this.entidad = new GuardadoJuegos()
            {
                FechaGuardado = DateOnly.FromDateTime(DateTime.Now),
                Proceso = "Nivel 1",
                Ubicacion = "/saves/test",
                HorasJugadas = "5h",
                UsuarioId = this.usuario.Id,
                VideojuegoId = this.videojuego.Id
            };
            this.iConexion.GuardadoJuegos!.Add(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Modificar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.entidad!.HorasJugadas = "10h";
            this.iConexion.GuardadoJuegos!.Update(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Borrar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.iConexion.GuardadoJuegos!.Remove(this.entidad!);
