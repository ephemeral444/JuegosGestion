...
namespace GestionesJ_Unitarias
{
    ...
    public class LogrosUT
    {
        ...
        private void Guardar()
        {
            ...
            this.iConexion.SaveChanges();
            this.entidad = new Logros()
            {
                NombreLogro = "UT-" + DateTime.Now.ToString(),
                Descripcion = "Logro de prueba",
                Rareza = "Oro",
                EstadoDesbloqueado = false,
                Puntos = 500,
                VideojuegoId = this.videojuego.Id
            };
            this.iConexion.Logros!.Add(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Modificar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.entidad!.EstadoDesbloqueado = true;
            this.iConexion.Logros!.Update(this.entidad!);
            this.iConexion.SaveChanges();
        ...
        private void Borrar()
        {
            this.iConexion = new Conexion();
            this.iConexion.string_conexion = Configuraciones.obtener("string_conexion");
            this.iConexion.Logros!.Remove(this.entidad!);
